    ...
    return (
        <div className="group bg-zinc-900 col-span relative h-[12vw]">
            <img
                ...
                alt={movie.title}
            />
            <div className="opacity-0 absolute top-0 transition duration-200 z-10 invisible sm:visible delay-300 w-full
                scale-0 group-hover:scale-110 group-hover:-translate-y-[6vw] group-hover:translate-x-[2vw]
                ...
                />
                <div className="z-10 bg-zinc-800 p-2 lg:p-4 abosolute w-full transition shadow-md rounded-b-md">
